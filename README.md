...
The purpose of this module is to allow requesting AI-assisted translations with a simple click from jContent.

## Installation

- In Jahia, go to "Administration --> Server settings --> System components --> Modules"
- Upload the JAR **ai-assisted-translations-X.X.X.jar**
...
## How to use
 ...
 - The AI-assisted translation menu should be displayed at the bottom with two sets of sub-items:
